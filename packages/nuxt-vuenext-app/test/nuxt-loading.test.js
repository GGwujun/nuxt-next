...
describe('nuxt-loading', () => {
  ...
  test('added when loading', async () => {
    ...
    expect(wrapper.html()).toBe(
      '<div class="nuxt-progress" style="width: 0%;"></div>',
    );
  });
  ...
  test('can fail', async () => {
    ...
    const html = wrapper.html();
    expect(html).toBe(
      '<div class="nuxt-progress nuxt-progress-failed" style="width: 50%;"></div>',
    );
  });
  ...
  test('continues after duration', async () => {
    ...
    let html = wrapper.html();
    expect(html).toBe(
      '<div class="nuxt-progress nuxt-progress-notransition" style="width: 100%; left: 0px;"></div>',
    );

...
describe('nuxt-link prefetch', () => {
  ...
  test('when router.prefetchLinks is set to false, link with no prop should not be prefetched', async () => {
  ...
  test('when router.prefetchLinks is set to false, link with prefetch prop set to true should be prefetched', async () => {
    const compiledTemplatePath = await compileTemplate(
      'components/nuxt-link.client.js',
  ...
  test('when router.prefetchLinks is set to true (default), link with no prop should be prefetched', async () => {
    const compiledTemplatePath = await compileTemplate(
      'components/nuxt-link.client.js',
  ...
  test('when router.prefetchLinks is set to true (default), link with prefetch prop set to false should not be prefetched', async () => {
    const compiledTemplatePath = await compileTemplate(
      'components/nuxt-link.client.js',
  ...
  test('when router.prefetchLinks is set to true (default), link with noPrefetch prop should not be prefetched', async () => {
    const compiledTemplatePath = await compileTemplate(
      'components/nuxt-link.client.js',
